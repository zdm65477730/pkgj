...
class VitasdkToolchainConan(ConanFile):
    ...
    def source(self):
        tools.download("https://github.com/vitasdk/autobuilds/releases/download/master-linux-v1198/vitasdk-x86_64-linux-gnu-2020-08-11_17-20-59.tar.bz2", filename="vitasdk.tar.bz2")
